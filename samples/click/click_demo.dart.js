...
$$.HashMapImplementation = {"":
 ...
 remove$1: function(key){var index=this._probeForLookup$1(key);if($.geB(index,0)){this._numberOfEntries=$.sub(this._numberOfEntries,1);var value=$.index(this._values,index);$.indexSet(this._values,index,null);$.indexSet(this._keys,index,$.CTC25);this._numberOfDeleted=$.add(this._numberOfDeleted,1);return value;}return;},
 isEmpty$0: function(){return $.eq(this._numberOfEntries,0);},
 get$length: function(){return this._numberOfEntries;},
 forEach$1: function(f){var length$=$.get$length(this._keys);if(typeof length$!=='number')return this.forEach$1$bailout(1,f,length$);for(var i=0;i<length$;++i){var key=$.index(this._keys,i);if(!(key==null)&&!(key===$.CTC25))f.call$2(key,$.index(this._values,i));}},
 forEach$1$bailout: function(state,f,length$){for(var i=0;$.ltB(i,length$);++i){var key=$.index(this._keys,i);if(!(key==null)&&!(key===$.CTC25))f.call$2(key,$.index(this._values,i));}},
...
$$._DoubleLinkedQueueIterator = {"":
 ...
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC11);this._currentEntry=this._currentEntry.get$_lib0_next();return this._currentEntry.get$element();},
...
$$._WhereIterator = {"":
 ...
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC11);this._next=null;return this._current;}
};
...
$$.PElement = {"":
 ...
 _invalidateParent$0: function(){this._invalidatedEventHandle.fireEvent$1($.CTC23);this._lib2_parent.childInvalidated$1(this);}
};
...
$$.Panel = {"":
 ...
 insertAt$2: function(element,index){if(index==null)index=0;element.registerParent$1(this);$.insertRange$3(this._children,index,1,element);$.CTC29.set$2(element,element.addTransform$0());this.onChildrenChanged$0();},
...
$$.ClickManager = {"":
 ...
 _doClick$2: function(element,e){$.CTC21.fireEvent$2(element,$.ElementMouseEventArgs_ElementMouseEventArgs(element,e));},
...
$$.ClickManager__mouseDown_anon = {"":
 [],
 "super": "Closure",
 call$1: function(e){return $.CTC17.get$1(e);}
};

$$.Mouse_markMouseOver_anon = {"":
 [],
 "super": "Closure",
 call$1: function(e){$.CTC19.clear$1(e);$.CTC16.clear$1(e);}
};

$$.Mouse_markMouseOver_anon0 = {"":
 [],
 "super": "Closure",
 call$1: function(e){$.CTC19.set$2(e,true);}
};
...
$.ClickDemo_ClickDemo = function(canvas){var pCanvas=$.PCanvas$(200,200,false);pCanvas.background='yellow';var blue=$.Shape$(100,100,'blue',$.CTC13);$.ClickManager_setClickable(blue,true);$.ClickManager_addHandler(blue,new $.ClickDemo_ClickDemo_anon(blue));pCanvas.addElement$1(blue);var green=$.Shape$(70,70,'green',$.CTC13);pCanvas.addElement$1(green);pCanvas.setTopLeft$2(green,$.Coordinate$(110,15));var red=$.Shape$(40,40,'red',$.CTC14);pCanvas.addElement$1(red);pCanvas.setCenter$2(red,$.Coordinate$(50,150));pCanvas.addTransform$0().translate$2($.div($.sub(canvas.get$width(),pCanvas.get$width()),2),$.div($.sub(canvas.get$height(),pCanvas.get$height()),2));var rootPanel=$.PCanvas$(500,500,false);rootPanel.addElement$1(pCanvas);var stage=$.Stage$(canvas,rootPanel);return $.ClickDemo$_internal(canvas,stage,$.ClickManager$(stage));};
...
$._convertNativeToDart_IDBKey = function(nativeKey){if(new $._convertNativeToDart_IDBKey_containsDate().call$1(nativeKey)===true)throw $.$$throw($.CTC26);return nativeKey;};
...
$.ClickManager_setClickable = function(element,value){if(value)$.CTC17.set$2(element,true);else $.CTC17.clear$1(element);};
...
$.Mouse_markMouseOver = function(stage,coordinate){$.requireArgumentNotNull(stage,'stage');var t1=!(coordinate==null);$.requireArgument(coordinate==null||coordinate.get$isValid()===true,'coordinate',null);var items=$.CTC15.get$1(stage);if(!(items==null)){$.forEach(items,new $.Mouse_markMouseOver_anon());$.CTC15.clear$1(stage);}if(t1){var hits=$.RetainedUtil_hitTest(stage,coordinate);$.CTC15.set$2(stage,hits);$.forEach(hits,new $.Mouse_markMouseOver_anon0());if($.gtB($.get$length(hits),0))$.CTC16.set$2($.index(hits,0),true);return hits;}return;};
...
$.ClickManager_addHandler = function(element,handler){return $.CTC21.addHandler$2(element,handler);};
...
$.CTC33 = false;
$.CTC34 = 'isClickable';
$.CTC17 = new Isolate.$isolateProperties.Property(false, 'isClickable');
$.CTC35 = '^#[_a-zA-Z]\\w*$';
...
$.CTC37 = null;
$.CTC38 = '_attachableEventHelperProperty';
...
$.CTC42 = 'IsMouseDirectlyOver';
$.CTC16 = new Isolate.$isolateProperties.Property(false, 'IsMouseDirectlyOver');
$.CTC43 = 'Rectangle';
$.CTC13 = new Isolate.$isolateProperties.ShapeType('Rectangle');
$.CTC31 = new Isolate.$isolateProperties.Object();
$.CTC44 = 'structured clone of FileList';
...
$.CTC52 = 'panelTransform';
$.CTC29 = new Isolate.$isolateProperties.Property(null, 'panelTransform');
...
$.CTC54 = '_stageMouseCacheProperty';
$.CTC15 = new Isolate.$isolateProperties.Property(null, '_stageMouseCacheProperty');
$.CTC55 = 'IDBKey containing Date';
$.CTC26 = new Isolate.$isolateProperties.NotImplementedException('IDBKey containing Date');
...
$.CTC27 = new Isolate.$isolateProperties.EmptyElementRect(Isolate.$isolateProperties.CTC58, Isolate.$isolateProperties.CTC58, Isolate.$isolateProperties.CTC58, Isolate.$isolateProperties.CTC58, Isolate.$isolateProperties.CTC10);
...
$.HashMapImplementation__DELETED_KEY = Isolate.$isolateProperties.CTC25;
