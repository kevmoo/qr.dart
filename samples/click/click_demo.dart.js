...
$$._DoubleLinkedQueueEntrySentinel = {"":
 ...
 remove$0: function(){$.$$throw($.CTC26);},
 _asNonSentinelEntry$0: function(){return;},
 get$element: function(){$.$$throw($.CTC26);},
...
$$.DoubleLinkedQueue = {"":
 ...
 isEmpty$0: function(){var t1=this._sentinel.get$_lib0_next();var t2=this._sentinel;return t1==null?t2==null:t1===t2;},
 clear$0: function(){var t1=this._sentinel;t1.set$_lib0_next(t1);t1=this._sentinel;t1.set$_previous(t1);},
 forEach$1: function(f){var entry=this._sentinel.get$_lib0_next();for(;t1=this._sentinel,!(entry==null?t1==null:entry===t1);){var nextEntry=entry.get$_lib0_next();f.call$1(entry.get$_lib0_element());entry=nextEntry;}var t1;},
...
$$._DoubleLinkedQueueIterator = {"":
 ...
 next$0: function(){if(this.hasNext$0()!==true)$.$$throw($.CTC12);this._currentEntry=this._currentEntry.get$_lib0_next();return this._currentEntry.get$element();},
...
$$.Enumerable = {"":
 [],
 "super": "Object",
 iterator$0: function(){$.$$throw($.CTC22);},
...
$$._WhereIterator = {"":
 ...
 next$0: function(){if(this.hasNext$0()!==true)$.$$throw($.CTC12);this._next=null;return this._current;}
};
...
$$.Panel = {"":
 ...
 insertAt$2: function(element,index){if(index==null)index=0;element.registerParent$1(this);$.insertRange$3(this._children,index,1,element);$.CTC32.set$2(element,element.addTransform$0());this.onChildrenChanged$0();},
 ...
 getChildTransform$1: function(child){return $.CTC32.get$1(child);},
...
$$.Mouse_markMouseOver_anon = {"":
 [],
 "super": "Closure",
 call$1: function(e){$.CTC20.clear$1(e);$.CTC17.clear$1(e);}
};

$$.Mouse_markMouseOver_anon0 = {"":
 [],
 "super": "Closure",
 call$1: function(e){$.CTC20.set$2(e,true);}
};
...
$._convertNativeToDart_IDBKey = function(nativeKey){if(new $._convertNativeToDart_IDBKey_containsDate().call$1(nativeKey)===true)$.$$throw($.CTC28);return nativeKey;};
...
$.requireArgument = function(truth,arg,message){if(!truth)if(!(message==null))$.$$throw($.DetailedIllegalArgumentException$(arg,message));else $.$$throw($.IllegalArgumentException$(arg));};
...
$.CTC29 = new Isolate.$isolateProperties._SimpleClientRect(0, 0, 0, 0);
...
$.CTC30 = new Isolate.$isolateProperties.EmptyElementRect(Isolate.$isolateProperties.CTC29, Isolate.$isolateProperties.CTC29, Isolate.$isolateProperties.CTC29, Isolate.$isolateProperties.CTC29, Isolate.$isolateProperties.CTC0);
...
$.CTC32 = new Isolate.$isolateProperties.Property(null, 'panelTransform');
...
$.$defineNativeClass('DOMStringList', ["length?"], {
 ...
 removeRange$2: function(start,rangeLength){$.$$throw($.CTC31);},
 insertRange$3: function(start,rangeLength,initialValue){$.$$throw($.CTC33);},
