  ...
  switch (state) {
    ...
    case 3:
      ...
      for (var i = 0; $.ltB(i, capacity); ++i) {
        ...
        if (key === (void 0) || key === $.CTC8) continue;
...
$$._JsonParser = {"":
 ...
 _lib5_nextChar$0: function() {
  ...
  if (typeof t2 !== 'number') return this._lib5_nextChar$0$bailout(3, t2, t1);
  if (t1 >= t2) return 0;
...
$.getRange2 = function(a, start, length$, accumulator) {
  if (typeof a !== 'string' && (typeof a !== 'object' || (a.constructor !== Array && !a.is$JavaScriptIndexingBehavior))) return $.getRange2$bailout(1, a, start, length$, accumulator);
  if (typeof start !== 'number') return $.getRange2$bailout(1, a, start, length$, accumulator);
  if ($.ltB(length$, 0)) throw $.captureStackTrace($.IllegalArgumentException$1('length'));
  if (start < 0) throw $.captureStackTrace($.IndexOutOfRangeException$1(start));
...
$.join2 = function(strings, separator) {
  if (typeof separator !== 'string') return $.join2$bailout(1, strings, separator);
  $.checkNull(strings);
  $.checkNull(separator);
...
$.join2$bailout = function(state, strings, separator) {
  $.checkNull(strings);
  $.checkNull(separator);
  for (var t1 = $.iterator(strings), first = true, result = ''; t1.hasNext$0() === true; ) {
    var t2 = t1.next$0();
...
$.getRange2$bailout = function(state, a, start, length$, accumulator) {
  if ($.ltB(length$, 0)) throw $.captureStackTrace($.IllegalArgumentException$1('length'));
