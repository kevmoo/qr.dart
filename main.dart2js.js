...
q=r&65535
if((B.jn.wG(r,16)&8191)===10)switch(q){case 438:return A.tW(a,A.T3(A.L(s)+" (Error "+q+")",null))
...
for(s=a.length;q<a.length;a.length===s||(0,A.q)(a),++q)a[q].n6(p)},
...
s=$.ol()
if(s.b.test(a)){if(!A.m2(a,s,0))A.vh(A.L3(a.length>10?B.xB.J(a,0,10)+"...":a,"alphaNumeric","String does not contain valid ALPHA-NUM character set"))
return A.QI([new A.HO(a)],t.v)}s=new A.qj(a)
if(s.V(s,new A.cN()))return A.QI([new A.wO(26),new A.eK(B.Qk.L(a))],t.v)
return A.QI([new A.eK(B.Qk.L(a))],t.v)},
qL(a){var s,r,q,p,o,n=$.Lw()
if(!n.b.test(a))throw A.b(A.L3(a.length>10?B.xB.J(a,0,10)+"...":a,"numberString","string can only contain digits 0-9"))
...
ty(a,b){var s=A.QI([],t.v)
if(a<1||a>40)A.vh(A.TE(a,1,40,"typeNumber",null))
return new A.pR(a,b,a*4+17,s)},
aP(a,b,c){var s,r,q,p,o,n,m,l,k=A.mV(a),j=new A.ON(k),i=new A.N3(j.$1(1),j.$1(10),j.$1(27)),h=A.QI([],t.t)
for(s=1;s<=40;++s)if(i.$1(s)<=A.Dk(s,b)){for(r=s;r<=40;++r)h.push(r)
break}q=A.QI([],t.B)
for(p=0;p<4;++p){o=B.TZ[p]
if(i.$1(c)<=A.Dk(c,o))q.push(o)}if(B.Nm.I(h,c)&&B.Nm.I(q,b)){n=A.ty(c,b)
for(m=k.length,l=n.e,p=0;p<k.length;k.length===m||(0,A.q)(k),++p){l.push(k[p])
n.d=null}}return new A.OQ(h,q)},
...
p.Dp(n.gp().c,4)
p.Dp(n.gB(n),n.gp().S(a))
n.KF(p)}s=p.b
if(s>r)throw A.b(new A.Tw("Input too long. "+s+" > "+r))
if(s+4<=r)p.Dp(0,4)
m=8-B.jn.Y(p.b,8)
if(m<8)p.Dp(0,m)
...
for(s=0;s<a;++s)q=q.tv(A.yU(A.QI([1,$.Wd()[B.jn.Y(s,255)]],r),0))
return q},
...
s=A.HQ(a,0,r)
q=a.d
s.NQ(q==null?a.d=A.fV(g,f,a.e):q)
p=new Uint8Array(e)
...
_.e=e
_.f=f},
t(){var s,r,q,p,o,n,m,l,k,j,i=v.G,h=i.document.querySelector("#content")
if(h==null)h=A.AN(h)
...
if(k==null)k=A.AN(k)
j=A.i3(h,s,r,q,p,l,k,m)
A.JE(l,"click",new A.dd(j),!1)
A.JE(k,"click",new A.aB(j),!1)
A.JE(o,"keyup",new A.oN(j,o),!1)
j.x.k(new A.qx(o,n,j),new A.rd(o,n,j))
j.y=o.value
j.T()
o.focus()
return j},
i3(a,b,c,d,e,f,g,h){var s,r,q,p=A.QI([],t.u),o=a.getContext("2d")
if(o==null)o=A.AN(o)
s=v.G.document.getElementById("type_auto")
if(s==null)s=A.AN(s)
r=t.r
q=A.x2(!1,t.H)
q.i(0,null)
p=new A.q9(a,o,b,c,f,g,h,s,A.eI(A.Cd(new A.Gm(h,A.Lh(h).C("Gm<1>")),A.HV(A.XA(),r),!0,A.A7(),new A.u8(q,A.Lh(q).C("u8<1>")),r,r),A.wr(),q.ght(q),r,t.E),B.Jd,p,B.JB)
p.PJ(a,b,c,d,e,f,g,h)
return p},
w8(a){return A.xG(a)},
...
s=1
break}p=A.ty(a.a,a.b)
p.Y0(g)
o=A.LW(p)
n=A.QI([],t.u)
for(g=p.c,m=o.e,l=o.a,k=l-1,j=0;j<g;++j)for(i=l<=j,h=0;h<g;++h){if(l<=h)A.vh(A.TE(h,0,k,"row",null))
if(i)A.vh(A.TE(j,0,k,"col",null))
n.push(m[h*l+j]===2)}q=n
s=1
break
...
return r},
n0(a){var s,r=a<<10>>>0
for(s=r;B.jn.gh(s)>=11;)s=(s^B.jn.yE(1335,B.jn.gh(s)-11))>>>0
return((r|s)^21522)>>>0},
Pa(a){var s,r=a<<12>>>0
for(s=r;B.jn.gh(s)>=13;)s=(s^B.jn.yE(7973,B.jn.gh(s)-13))>>>0
return(r|s)>>>0},
MN(a){},
E2(){A.t()}},B={}
var w=[A,J,B]
...
return this.X(a,b)},
K(a,b){return(a|0)===a?a/b|0:this.X(a,b)},
X(a,b){var s=a/b
if(s>=-2147483648&&s<=2147483647)return s|0
if(s>0){if(s!==1/0)return Math.floor(s)}else if(s>-1/0)return Math.ceil(s)
throw A.b(A.u0("Result of truncating division is "+A.L(s)+": "+A.L(a)+" ~/ "+A.L(b)))},
...
s.push(n)}m.a.oo(s)}else{s=A.QI([],t.G)
...
A.zF.prototype={}
A.E3.prototype={
L(a){var s,r,q=A.jB(0,null,a.length)
...
return!0}else{o.H()
return!1}},
m(a,b,c){var s,r,q,p,o,n,m,l,k=this
...
m=p+1
if(k.O(o,a.charCodeAt(m)))p=m}else if(n===56320){if(k.b+3>q)break
...
if(typeof q=="string"){if(q.length>78)q=B.xB.J(q,0,75)+"..."
return r+"\n"+q}else return r}}
A.cX.prototype={
...
q[p]=a
g.b=r
return}for(q=g.a,p=q.$flags|0,o=b;o>0;o=k){n=B.jn.wG(s,3)
m=8-(s&7)
l=o<m?o:m
k=o-l
j=B.jn.HZ(a,k)
...
q[n]=(h|i)>>>0
s+=l}g.b=r},
"["(a){var s,r,q,p,o,n,m,l=this.b,k=new Uint8Array(l),j=B.jn.wG(l,3)
...
gp(){return B.oK}}
A.HO.prototype={
KF(a){var s,r,q,p,o=this.a,n=o.length,m=B.jn.Y(n,2),l=n-m
...
a.Dp(o,6)}},
gB(a){return this.a.length},
gh(a){var s=this.a.length,r=B.jn.Y(s,2),q=B.jn.K(s,2)*11
return r===1?q+6:q},
$io1:1,
gp(){return B.Tv}}
A.pH.prototype={
...
f[n]=(m^$.Wd()[B.jn.Y(q+l,255)])>>>0}}return new A.E4(f)},
...
A.ON.prototype={
$1(a){var s,r,q,p,o
for(s=this.a,r=s.length,q=0,p=0;p<s.length;s.length===r||(0,A.q)(s),++p){o=s[p]
q+=4+o.gp().S(a)+o.gh(o)}return q},
$S:12}
A.N3.prototype={
...
q.$flags&2&&A.cW(q)
q[o]=n}},
Pv(a,b){var s,r,q,p,o,n,m,l,k,j=this,i=A.n0((j.c.a<<3|a)>>>0)
...
p=h
break}}}},
PT(a2,a3){var s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0=this.a,a1=a0-1
for(s=7===a2,r=6===a2,q=5===a2,p=4===a2,o=3===a2,n=2===a2,m=1===a2,l=0===a2,k=this.e,j=k.$flags|0,i=a1,h=-1;i>0;i-=2){if(i===6)--i
for(;;){for(g=a1*a0,f=(a1&1)===0,e=0;e<2;++e){d=i-e
c=g+d
if(a3[c]===0){A:{if(l){b=(a1+d&1)===0
break A}if(m){b=f
break A}if(n){b=B.jn.Y(d,3)===0
break A}if(o){b=B.jn.Y(a1+d,3)===0
break A}if(p){b=(B.jn.K(a1,2)+B.jn.K(d,3)&1)===0
break A}if(q){b=a1*d
b=B.jn.Y(b,2)+B.jn.Y(b,3)===0
break A}if(r){b=a1*d
b=(B.jn.Y(b,2)+B.jn.Y(b,3)&1)===0
break A}if(s){b=(B.jn.Y(a1*d,3)+B.jn.Y(a1+d,2)&1)===0
break A}b=!1
break A}if(b){b=k[c]
j&2&&A.cW(k)
k[c]=b^3}}}a1+=h
...
A.q9.prototype={
LT(){this.a.toBlob(A.k6(new A.JC()))},
PJ(a,b,c,d,e,f,g,a0){var s,r,q,p,o,n,m,l,k,j,i=this,h="change"
i.b.fillStyle="black"
s=i.w
s.checked=i.Q
A.JE(s,h,new A.a2(i),!1)
...
B.Nm.GT(m,new A.hR())
for(r=m.length,o=i.gV3(),l=0;l<m.length;m.length===r||(0,A.q)(m),++l){k=m[l]
...
this.e.disabled=s
this.f.disabled=s},
j(){if(!this.ay){this.ay=!0
v.G.window.requestAnimationFrame(A.k6(this.gU()))}},
AS(a){var s=this,r=a.target
if(r==null)r=A.AN(r)
s.z=A.QA(r.dataset.type_value)
s.Q=!1
s.w.checked=!1
s.T()},
zg(a){var s=a.target
this.as=B.Nm.XG(B.TZ,new A.Wx(s==null?A.AN(s):s))
this.T()},
T(){var s=this
s.D()
s.r.i(0,new A.oy(s.z,s.as,s.y))},
D(){var s,r,q,p,o,n=this,m=n.y,l=n.z,k=A.aP(m,n.as,l)
if(n.Q&&k.b.length!==0){m=B.Nm.gn(k.b)
n.z=m
s=v.G.document.getElementById("type_"+m)
if(s!=null)s.checked=!0}r=new A.Pd()
for(m=k.b,q=1;q<=10;++q)r.$2("type_"+q,B.Nm.I(m,q))
for(m=k.c,p=0;p<4;++p){o=B.TZ[p]
r.$2("error_"+o.b,B.Nm.I(m,o))}},
dF(a){var s,r=this
r.ay=!1
s=r.a
s.hidden=r.ax!==B.JB
r.c.hidden=r.ax!==B.cV
r.d.hidden=r.ax!==B.bA
if(r.ax===B.JB){r.b.clearRect(0,0,s.width,s.height)
r.cB()}},
cB(){var s,r,q,p=this,o=B.CD.yu(Math.sqrt(J.Hm(p.at))),n=p.a,m=n.width,l=n.height,k=o+1,j=B.jn.v(Math.min(A.E0(m),A.E0(l)),1.1*k),i=new A.Ng(1,0,0,1,0,0)
...
if(J.RS(p.at)){n.fillStyle="white"
n.fillRect(-0.5,-0.5,k,k)
n.fillStyle="black"
n.beginPath()
for(s=0;s<o;++s)for(m=s*o,r=0;r<o;){q=r+1
if(J.x9(p.at,m+r)){for(;;){if(!(q<o&&J.x9(p.at,m+q)))break;++q}n.rect(s,r,1,q-r)
...
r.tS(!1)}else{r.ax=B.JB
r.tS(!0)
r.at=a
s.innerText="Input size: "+r.y.length+" bytes"}r.j()},
$S:26}
A.rd.prototype={
$1(a){var s,r
...
s.style.color="red"
r=this.c
s.innerText="Input too long ("+r.y.length+" bytes)"
r.ax=B.cV
r.tS(!1)
r.j()},
$S:27}
...
if(q==null)return
s=r.document.querySelector('label[for="'+A.L(q.id)+'"]')
if(s==null)return
...
p(j,"gbY","QE",0)
p(j,"gts","lJ",0)
l(A,"XA",2,null,["$1$2","$2"],["r5",function(a,b){return A.r5(a,b,t.z)}],34,0)
l(A,"Na",3,null,["$1$3","$3"],["Dx",function(a,b,c){return A.Dx(a,b,c,t.z)}],35,0)
s(A,"wr","w8",24)
k(j=A.q9.prototype,"gHk","AS",1)
k(j,"gV3","zg",1)
k(j,"gU","dF",25)
s(A,"A7","MN",3)})();(function inheritance(){var s=hunkHelpers.mixin,r=hunkHelpers.inherit,q=hunkHelpers.inheritMany
r(A.j,null)
q(A.j,[A.FK,J.vB,A.rY,J.m,A.Ge,A.ar,A.o,A.zl,A.cX,A.a7,A.MH,A.SU,A.Re,A.Zr,A.te,A.bq,A.XO,A.il,A.db,A.N6,A.VR,A.Jc,A.ET,A.lY,A.W3,A.ih,A.OH,A.qh,A.KA,A.WV,A.ru,A.Pf,A.Fe,A.vs,A.OM,A.Kd,A.VT,A.of,A.fI,A.yR,A.B3,A.EM,A.xI,A.m0,A.t3,A.zF,A.Rw,A.ck,A.VS,A.CD,A.aE,A.c8,A.Zd,A.v,A.eL,A.eK,A.Dw,A.HO,A.wO,A.Tw,A.E4,A.pR,A.P2,A.dI,A.OQ,A.Fk,A.xC,A.Ng,A.q9,A.oy])
...
r(A.w2,A.ar)
r(A.qj,A.w2)
q(A.o,[A.Ay,A.fe,A.E1,A.lc,A.dC,A.VX,A.th,A.ha,A.WM,A.tK,A.QG,A.Bg,A.fs,A.ey,A.Xk,A.jZ,A.B5,A.OR,A.Pb,A.cN,A.ON,A.N3,A.A2,A.fp,A.XN,A.Pq,A.rz,A.r7,A.vN,A.dd,A.aB,A.oN,A.qx,A.rd,A.JC,A.a2,A.Wx])
...
q(A.lc,[A.zx,A.rT])
q(A.il,[A.N5,A.bA])
q(A.E1,[A.wN,A.SX,A.Gs,A.TM,A.FZ,A.GA,A.D3,A.kb,A.hR,A.Pd])
q(A.eH,[A.df,A.b0])
q(A.b0,[A.RG,A.WB])
r(A.rZ,A.RG)
r(A.Dg,A.rZ)
...
return{J:s("I2"),Y:s("Wy"),V:s("qj"),W:s("bQ<@>"),C:s("Ge"),F:s("oI"),q:s("Un"),Z:s("EH"),O:s("rF"),e:s("X6"),U:s("ZX"),c:s("cX<@>"),M:s("jd<b8<~>>"),d:s("jd<vm>"),p:s("jd<zM<KN>>"),v:s("jd<o1>"),B:s("jd<Ad>"),x:s("jd<dI>"),s:s("jd<qU>"),u:s("jd<SQ>"),b:s("jd<@>"),t:s("jd<KN>"),G:s("jd<OH?>"),a:s("jd<lf>"),T:s("PE"),m:s("vm"),g:s("c5"),f:s("Xj<@>"),j:s("zM<@>"),P:s("c8"),K:s("j"),L:s("VY"),l:s("Gz"),N:s("qU"),R:s("y5"),_:s("E"),h:s("HS"),bk:s("Pz"),ca:s("zt"),bX:s("n6"),o:s("kd"),r:s("oy"),aY:s("vs<@>"),aQ:s("vs<KN>"),D:s("vs<~>"),A:s("YF<j?,j?>"),y:s("SQ"),i:s("CP"),z:s("@"),w:s("@(j)"),Q:s("@(j,Gz)"),S:s("KN"),bc:s("b8<c8>?"),b1:s("vm?"),E:s("zM<SQ>?"),cl:s("zM<KN>?"),X:s("j?"),aD:s("qU?"),cG:s("SQ?"),dd:s("CP?"),I:s("KN?"),ae:s("lf?"),n:s("lf"),H:s("~"),bo:s("~(j)"),k:s("~(j,Gz)")}})();(function constants(){var s=hunkHelpers.makeConstList
B.Ok=J.vB.prototype
B.Nm=J.jd.prototype
B.jn=J.im.prototype
B.CD=J.qI.prototype
