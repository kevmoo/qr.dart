...
$$._SpreadArgsHelper = {"":
 ["_lib3_callback?", "_expectedCalls", "_actualCalls=", "_testNum", "_testCase", "_shouldCallBack", "_isDone"],
 "super": "Object",
...
$$._ExceptionMatcher = {"":
 [],
 "super": "BaseMatcher",
 describe$1: function(description){return description.add$1(this._lib3_name);}
};

$$._ArgumentError = {"":
 ["_lib3_name"],
 "super": "_ExceptionMatcher",
 matches$2: function(item,matchState){return typeof item==='object'&&item!==null&&!!item.is$ArgumentError;}
};
...
$$._IsCloseTo = {"":
 ["_lib3_value?", "_delta"],
 "super": "BaseMatcher",
 matches$2: function(item,matchState){if(typeof item!=='number')return this.matches$2$bailout(1,item);if(!(typeof item==='number'&&Math.floor(item) === item||typeof item==='number'))return false;var diff=item-this._lib3_value;if(diff<0)diff=-diff;return diff<=this._delta;},
 matches$2$bailout: function(state,item){if(!(typeof item==='number'&&Math.floor(item) === item||typeof item==='number'))return false;var diff=$.sub(item,this._lib3_value);if($.ltB(diff,0))diff=$.neg(diff);return $.le(diff,this._delta);},
 describe$1: function(description){return $.add$1(description.add$1('a numeric value within ').addDescriptionOf$1(this._delta),' of ').addDescriptionOf$1(this._lib3_value);},
 describeMismatch$4: function(item,mismatchDescription,matchState,verbose){if(!(typeof item==='number'))return $.add$1(mismatchDescription.addDescriptionOf$1(item),' not numeric');else{var t1=this._lib3_value;if(typeof t1!=='number')throw $.iae(t1);var diff=item-t1;if(diff<0)diff=-diff;return $.add$1(mismatchDescription.addDescriptionOf$1(item),' differed by ').addDescriptionOf$1(diff);}}
};
...
$$.TestPropertyEventIntegration = {"":
 ...
 get$name: function(){return $.get$TestPropertyEventIntegration__nameProperty().get$1(this);},
 set$name: function(value){$.get$TestPropertyEventIntegration__nameProperty().set$2(this,value);},
 get$nameChanged: function(){return this._nameChangedEventHandle;},
 get$age: function(){return $.get$TestPropertyEventIntegration__ageProperty().get$1(this);},
 set$age: function(value){$.get$TestPropertyEventIntegration__ageProperty().set$2(this,value);},
 get$ageChanged: function(){return this._ageChangedEventHandle;},
 reset$0: function(){$.get$TestPropertyEventIntegration__nameProperty().clear$1(this);$.get$TestPropertyEventIntegration__ageProperty().clear$1(this);},
 TestPropertyEventIntegration$0: function(){$.get$TestPropertyEventIntegration__nameProperty().addHandler$2(this,new $.anon(this));$.get$TestPropertyEventIntegration__ageProperty().addHandler$2(this,new $.anon0(this));}
};
...
$$.Enumerable = {"":
 ...
 first$1: function(f){if(f==null)f=new $.Enumerable_first_anon();var iter=$._WhereIterator$(this.iterator$0(),f);if(iter.hasNext$0()!==true)throw $.$$throw($.CTC34);return iter.next$0();},
 first$0: function() {
...
$$._DistinctIterator = {"":
 ["_source", "_comparer", "_found", "_lib5_next=", "_current?"],
 "super": "Object",
 _comparer$2: function(arg0, arg1) { return this._comparer.call$2(arg0, arg1); },
 hasNext$0: function(){if(this._lib5_next==null){this._lib5_next=false;for(var t1=this._source,t2=this._found;t1.hasNext$0()===true;){this._current=t1.next$0();if($.every(t2,new $._DistinctIterator_hasNext_anon(this))===true){this._lib5_next=true;t2.push(this._current);break;}}}return this._lib5_next;},
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC11);this._lib5_next=null;return this._current;}
};
...
$$.IndexIterator = {"":
 ...
 "super": "Object",
 hasNext$0: function(){var t1=this._lib5_length;if(typeof t1!=='number')return this.hasNext$0$bailout(1,t1,0);var t3=this._lib5_pos;if(typeof t3!=='number')return this.hasNext$0$bailout(2,t1,t3);return t1>t3;},
 hasNext$0$bailout: function(state,env0,env1){switch(state){case 1:t1=env0;break;case 2:t1=env0;t3=env1;break;}switch(state){case 0:var t1=this._lib5_length;case 1:state=0;var t3=this._lib5_pos;case 2:state=0;return $.gt(t1,t3);}},
 next$0: function(){if(this.hasNext$0()!==true)throw $.$$throw($.CTC11);var t1=this._lib5_pos;if(typeof t1!=='number')return this.next$0$bailout(1,t1);this._lib5_pos=t1+1;return this._indexer$1(t1);},
 next$0$bailout: function(state,t1){this._lib5_pos=$.add(t1,1);return this._indexer$1(t1);},
...
$$.Grouping = {"":
 ["_lib5_values"],
 "super": "Object",
 containsKey$1: function(key){return this._lib5_values.containsKey$1(key);},
 operator$index$1: function(key){return $.index(this._lib5_values,key);},
 forEach$1: function(f){return $.forEach(this._lib5_values,f);},
 getKeys$0: function(){return this._lib5_values.getKeys$0();},
 getValues$0: function(){return $.$$(this._lib5_values.getValues$0()).selectMany$1(new $.Grouping_getValues_anon());},
 get$length: function(){return $.get$length(this._lib5_values);},
 get$isEmpty: function(){return $.isEmpty(this._lib5_values);},
 isEmpty$0: function() { return this.get$isEmpty().call$0(); },
 toString$0: function(){return $.toString(this._lib5_values);},
 Grouping$2: function(source,keyFunc){if(keyFunc==null)keyFunc=new $.anon1();for(var t1=$.iterator(source),t2=this._lib5_values;t1.hasNext$0()===true;){var t3=t1.next$0();$.add$1(t2.putIfAbsent$2(keyFunc.call$1(t3),new $.anon2()),t3);}}
};
...
$$.Array2d = {"":
 ...
 getAdjacent$2: function(x,y){return $.ListImplementation_List$from($.map(this.getAdjacentIndices$2(x,y),new $.Array2d_getAdjacent_anon(this)));},
 getAdjacentIndices$2: function(x,y){var adj=$.ListImplementation_List(null);for(var k=$.max(0,y-1),t1=this.height,t2=y+2,t3=x-1,t4=this.width,t5=x+2;k<$.min(t1,t2);++k)for(var j=$.max(0,t3),t6=!(k===y);j<$.min(t4,t5);++j)if(!(j===x)||t6)adj.push(this._getIndex$2(j,k));return adj;},
...
$$.TarjanCycleDetect = {"":
 ["_lib5_index", "_stack", "_scc", "_lib5_list"],
 "super": "Object",
 _executeTarjan$0: function(){for(var t1=$.iterator($.ListImplementation_List$from(this._lib5_list.getSourceNodeSet$0()));t1.hasNext$0()===true;){var t2=t1.next$0();if($.eqB(t2.get$index(),-1))this._tarjan$1(t2);}return this._scc;},
 _tarjan$1: function(v){v.set$index(this._lib5_index);v.set$lowlink(this._lib5_index);var t1=this._lib5_index;if(typeof t1!=='number')return this._tarjan$1$bailout(1,v,t1,0,0,0);this._lib5_index=t1+1;var t3=this._stack;$.insertRange$3(t3,0,1,v);for(t1=$.iterator(this._lib5_list.getAdjacent$1(v));t1.hasNext$0()===true;){var t2=t1.next$0();var t4=t2.get$index();if(typeof t4!=='number')return this._tarjan$1$bailout(2,v,t4,t3,t1,t2);if(t4===-1){this._tarjan$1(t2);v.set$lowlink($.min(v.get$lowlink(),t2.get$lowlink()));}else{t4=$.indexOf$1(t3,t2);if(typeof t4!=='number')return this._tarjan$1$bailout(3,v,t4,t3,t1,t2);if(t4>=0)v.set$lowlink($.min(v.get$lowlink(),t2.get$index()));}}if($.eqB(v.get$lowlink(),v.get$index())){var component=$.ListImplementation_List(null);var n=null;do{if(0>=t3.length)throw $.ioore(0);n=t3[0];$.removeRange(t3,0,1);component.push(n.get$value());}while(!$.eqB(n,v));this._scc.push(component);}},
 _tarjan$1$bailout: function(state,env0,env1,env2,env3,env4){switch(state){case 1:var v=env0;t1=env1;break;case 2:v=env0;t4=env1;t3=env2;t1=env3;t2=env4;break;case 3:v=env0;t4=env1;t3=env2;t1=env3;t2=env4;break;}switch(state){case 0:v.set$index(this._lib5_index);v.set$lowlink(this._lib5_index);var t1=this._lib5_index;case 1:state=0;this._lib5_index=$.add(t1,1);var t3=this._stack;$.insertRange$3(t3,0,1,v);t1=$.iterator(this._lib5_list.getAdjacent$1(v));default:L0:while(true)switch(state){case 0:if(!(t1.hasNext$0()===true))break L0;var t2=t1.next$0();var t4=t2.get$index();case 2:state=0;case 3:if(state===0&&$.eqB(t4,-1)){this._tarjan$1(t2);v.set$lowlink($.min(v.get$lowlink(),t2.get$lowlink()));}else switch(state){case 0:t4=$.indexOf$1(t3,t2);case 3:state=0;if($.geB(t4,0))v.set$lowlink($.min(v.get$lowlink(),t2.get$index()));}}if($.eqB(v.get$lowlink(),v.get$index())){var component=$.ListImplementation_List(null);var n=null;do{if(0<0||0>=t3.length)throw $.ioore(0);n=t3[0];$.removeRange(t3,0,1);component.push(n.get$value());}while(!$.eqB(n,v));this._scc.push(component);}}}
};
...
$$.AttachableObject = {"":
 [],
 "super": "DisposableImpl",
 _addHandler$2: function(property,watcher){return $.add$1(this._eventHandlers.putIfAbsent$2(property,new $.AttachableObject__addHandler_anon()),watcher);},
 _removeHandler$2: function(property,handlerId){$.requireArgumentNotNull(handlerId,'handlerId');var handle=$.index(this._eventHandlers,property);if(!(handle==null))return handle.remove$1(handlerId);return false;},
 _fireEvent$2: function(attachable,args){var handle=$.index(this._eventHandlers,attachable);if(!(handle==null))handle.fireEvent$1(args);},
 ...
 _remove$1: function(key){if(this._isSet$1(key)===true){this._propertyValues.remove$1(key);this._fireChange$1(key);}},
...
$$.Property = {"":
 ...
 clear$1: function(obj){obj._remove$1(this);},
 isSet$1: function(obj){return obj._isSet$1(this);},
 addHandler$2: function(obj,handler){return obj._addHandler$2(this,handler);},
 removeHandler$2: function(obj,handlerId){return obj._removeHandler$2(this,handlerId);},
...
$$.AttachedEvent = {"":
 ...
 "super": "Attachable",
 addHandler$2: function(obj,handler){return obj._addHandler$2(this,handler);},
 removeHandler$2: function(obj,handlerId){$.requireArgumentNotNull(obj,'obj');return obj._removeHandler$2(this,handlerId);},
...
$$.TestVector_run_anon4 = {"":
 [],
 "super": "Closure",
 call$0: function(){$.expect($.Vector$(2,2),$.Vector$(2,2),null,null,false);$.expect($.CTC51,$.same($.CTC51),null,null,false);}
};
...
$$.TestCoordinate_run_anon2 = {"":
 [],
 "super": "Closure",
 call$0: function(){$.expect($.Coordinate$(2,2),$.isNot($.same($.Coordinate$(2,2))),null,null,false);$.expect($.CTC47,$.same($.CTC47),null,null,false);}
};
...
$$.TestListBase_run_anon = {"":
 [],
 "super": "Closure",
 call$0: function(){$.test('filter',$.TestListBase__testFilter);$.test('forEach',$.TestListBase__testForEach);$.test('getRange',$.TestListBase__testRange);$.test('indexOf',$.TestListBase__testIndexOf);$.test('map',$.TestListBase__testMap);$.test('reduce',$.TestListBase__testReduce);$.test('simple',$.TestListBase__testSimple);$.test('some and all',$.TestListBase__testSomeAll);}
};
...
$$.anon = {"":
 ["this_0"],
 "super": "Closure",
 call$1: function(args){this.this_0.get$_nameChangedEventHandle().fireEvent$1($.CTC19);}
};

$$.anon0 = {"":
 ["this_1"],
 "super": "Closure",
 call$1: function(args){this.this_1.get$_ageChangedEventHandle().fireEvent$1($.CTC19);}
};
...
$$.TestAttachedEvents__testRemove_anon = {"":
 ["obj_0"],
 "super": "Closure",
 call$0: function(){return $.get$TestAttachedEvents__testEvent1().removeHandler$2(this.obj_0,null);}
};

$$.TestAttachedEvents__testRemove_anon0 = {"":
 [],
 "super": "Closure",
 call$0: function(){return $.get$TestAttachedEvents__testEvent1().removeHandler$2(null,$.GlobalId_GlobalId());}
};
...
$$._SpreadArgsHelper_invoke1_anon = {"":
 ["this_1", "arg1_0"],
 "super": "Closure",
 call$0: function(){var t1=this.this_1;t1.set$_actualCalls($.add(t1.get$_actualCalls(),1));if(t1._shouldCallBack$0()===true)return t1._lib3_callback$1(this.arg1_0);}
};
...
$$.Enumerable_exclude_anon = {"":
 ["f_1"],
 "super": "Closure",
 call$1: function(s){return $._WhereIterator$(s,this.f_1);}
};
...
$$.TestArray2d__testReadonlyFromCtorParams_anon = {"":
 [],
 "super": "Closure",
 call$0: function(){return $.Array2d_Array2d$readonlyFrom(null,[0,1,2,3]);}
};

$$.TestArray2d__testReadonlyFromCtorParams_anon0 = {"":
 [],
 "super": "Closure",
 call$0: function(){return $.Array2d_Array2d$readonlyFrom(2,null);}
};

$$.TestArray2d__testReadonlyFromCtorParams_anon1 = {"":
 [],
 "super": "Closure",
 call$0: function(){return $.Array2d_Array2d$readonlyFrom(0,[0,1,2,3]);}
};

$$.TestArray2d__testReadonlyFromCtorParams_anon2 = {"":
 [],
 "super": "Closure",
 call$0: function(){return $.Array2d_Array2d$readonlyFrom(3,[0,1,2,3]);}
};

$$.TestArray2d__testReadonlyFromCtorParams_anon3 = {"":
 [],
 "super": "Closure",
 call$0: function(){return $.Array2d_Array2d$readonlyFrom(3,[]);}
};
...
$.TestEnumerable__testLength = function(){$.expect($.get$length($.$$([1,2,3,4,5,6])),$.equals(6,100),null,null,false);};
...
$.TestAttachedEvents__testWholeDeal = function(){var watcher1=$.EventWatcher$();var watcher2=$.EventWatcher$();var obj=$.TestAttachedEvents$();var h1=$.get$TestAttachedEvents__testEvent1().addHandler$2(obj,watcher1.get$handler());var h2=$.get$TestAttachedEvents__testEvent2().addHandler$2(obj,watcher2.get$handler());$.get$TestAttachedEvents__testEvent1().fireEvent$2(obj,$.CTC19);$.expect(watcher1.get$eventCount(),$.equals(1,100),null,null,false);$.expect(watcher2.get$eventCount(),$.equals(0,100),null,null,false);$.get$TestAttachedEvents__testEvent2().fireEvent$2(obj,$.CTC19);$.expect(watcher1.get$eventCount(),$.equals(1,100),null,null,false);$.expect(watcher2.get$eventCount(),$.equals(1,100),null,null,false);$.expect($.get$TestAttachedEvents__testEvent1().removeHandler$2(obj,h1),$.CTC15,null,null,false);var h3=$.get$TestAttachedEvents__testEvent1().addHandler$2(obj,watcher2.get$handler());$.get$TestAttachedEvents__testEvent1().fireEvent$2(obj,$.CTC19);$.expect(watcher1.get$eventCount(),$.equals(1,100),null,null,false);$.expect(watcher2.get$eventCount(),$.equals(2,100),null,null,false);$.expect($.get$TestAttachedEvents__testEvent1().removeHandler$2(obj,h1),$.CTC,null,null,false);$.expect($.get$TestAttachedEvents__testEvent1().removeHandler$2(obj,h2),$.CTC,null,null,false);$.expect($.get$TestAttachedEvents__testEvent2().removeHandler$2(obj,h2),$.CTC15,null,null,false);$.expect($.get$TestAttachedEvents__testEvent2().removeHandler$2(obj,h2),$.CTC,null,null,false);$.expect($.get$TestAttachedEvents__testEvent1().removeHandler$2(obj,h3),$.CTC15,null,null,false);$.expect($.get$TestAttachedEvents__testEvent1().removeHandler$2(obj,h3),$.CTC,null,null,false);};
...
$._SimpleNumEnumerable$ = function(_source){return new $._SimpleNumEnumerable(_source);};
...
$.charCodes = function(receiver){var len=receiver.length;var result=$.ListImplementation_List(len);for(var i=0;i<len;++i){var t1=$.charCodeAt(receiver,i);if(i<0||i>=result.length)throw $.ioore(i);result[i]=t1;}return result;};

$.NumberEnumerable_NumberEnumerable$from = function(source){$.requireArgumentNotNull(source,'source');return $._SimpleNumEnumerable$(source);};
...
$.TestBox__testValid = function(){var validLocations=[-1,0,1];var validSizes=[0,1];var invalidLocations=[(0/0),(-1/0),(1/0),null];var invalidSizes=[(0/0),(-1/0),(1/0),null,-1];for(var t1=$.iterator(validLocations),a=null;t1.hasNext$0()===true;){var t2=t1.next$0();for(var t3=$.iterator(validLocations);t3.hasNext$0()===true;){var t4=t3.next$0();for(var t5=$.iterator(validSizes);t5.hasNext$0()===true;){var t6=t5.next$0();for(var t7=$.iterator(validSizes);t7.hasNext$0()===true;){var t8=t7.next$0();a=$.Box$(t2,t4,t6,t8);$.expect(a.get$isValid(),$.CTC15,null,null,false);for(var t9=$.iterator(invalidLocations);t9.hasNext$0()===true;){var t10=t9.next$0();$.expect($.Box$(t10,t4,t6,t8).get$isValid(),$.CTC,null,null,false);a=$.Box$(t2,t10,t6,t8);$.expect(a.get$isValid(),$.CTC,null,null,false);}for(t9=$.iterator(invalidSizes);t9.hasNext$0()===true;){t10=t9.next$0();$.expect($.Box$(t2,t4,t10,t8).get$isValid(),$.CTC,null,null,false);a=$.Box$(t2,t4,t6,t10);$.expect(a.get$isValid(),$.CTC,null,null,false);}}}}}};
...
$.RgbColor__normalizeHex = function(hexColor){if($.CTC53.hasMatch$1(hexColor)!==true)throw $.$$throw($.IllegalArgumentException$('\''+$.S(hexColor)+'\' is not a valid hex color'));return $.toLowerCase(hexColor);};
...
$.TestTarjanCycleDetect__test5Line = function(){var graph=$.HashMapImplementation$();graph.operator$indexSet$2(1,null);graph.operator$indexSet$2(2,$.HashSet_HashSet$from([1]));graph.operator$indexSet$2(3,$.HashSet_HashSet$from([2]));graph.operator$indexSet$2(4,$.HashSet_HashSet$from([3]));graph.operator$indexSet$2(5,$.HashSet_HashSet$from([4]));var result=$.TarjanCycleDetect_getStronglyConnectedComponents(graph);$.expect($.get$length(result),$.equals(5,100),null,null,false);$.expect($.index(result,0),$.unorderedEquals([1]),null,null,false);$.expect($.index(result,1),$.unorderedEquals([2]),null,null,false);$.expect($.index(result,2),$.unorderedEquals([3]),null,null,false);$.expect($.index(result,3),$.unorderedEquals([4]),null,null,false);$.expect($.index(result,4),$.unorderedEquals([5]),null,null,false);};
...
$.TestEnumerable__testIsEmpty = function(){$.expect($.isEmpty($.$$([])),$.CTC15,null,null,false);$.expect($.isEmpty($.$$([1])),$.CTC,null,null,false);};
...
$._DistinctIterator$ = function(_source,_comparer){return new $._DistinctIterator(_source,_comparer,$.ListImplementation_List(null),null,null);};
...
$._ElementFactoryProvider_createElement_html = function(html){var match=$.CTC23.firstMatch$1(html);if(!(match==null)){var tag=$.toLowerCase(match.group$1(1));var parentTag=$.CTC24.containsKey$1(tag)===true?$.CTC24.operator$index$1(tag):'div';}else{parentTag='div';tag=null;}var temp=$.Element_Element$tag(parentTag);temp.set$innerHTML(html);if($.eqB($.get$length(temp.get$elements()),1))var element=temp.get$elements().get$first();else if($.eqB(parentTag,'html')&&$.eqB($.get$length(temp.get$elements()),2)){var t1=temp.get$elements();element=$.index(t1,$.eqB(tag,'head')?0:1);}else throw $.$$throw($.ArgumentError$('HTML had '+$.S($.get$length(temp.get$elements()))+' '+'top level elements but 1 expected'));element.remove$0();return element;};
...
$.TestTarjanCycleDetect__test5Random = function(){var graph=$.HashMapImplementation$();graph.operator$indexSet$2(1,$.HashSet_HashSet$from([2]));graph.operator$indexSet$2(2,$.HashSet_HashSet$from([3]));graph.operator$indexSet$2(3,$.HashSet_HashSet$from([2]));graph.operator$indexSet$2(4,$.HashSet_HashSet$from([1]));graph.operator$indexSet$2(5,$.HashSet_HashSet$from([4]));var result=$.TarjanCycleDetect_getStronglyConnectedComponents(graph);$.expect($.get$length(result),$.equals(4,100),null,null,false);$.expect($.index(result,0),$.unorderedEquals([2,3]),null,null,false);$.expect($.index(result,1),$.unorderedEquals([1]),null,null,false);$.expect($.index(result,2),$.unorderedEquals([4]),null,null,false);$.expect($.index(result,3),$.unorderedEquals([5]),null,null,false);};
...
$.TestTarjanCycleDetect__test5Loop = function(){var graph=$.HashMapImplementation$();graph.operator$indexSet$2(1,$.HashSet_HashSet$from([5]));graph.operator$indexSet$2(2,$.HashSet_HashSet$from([1]));graph.operator$indexSet$2(3,$.HashSet_HashSet$from([2]));graph.operator$indexSet$2(4,$.HashSet_HashSet$from([3]));graph.operator$indexSet$2(5,$.HashSet_HashSet$from([4]));var result=$.TarjanCycleDetect_getStronglyConnectedComponents(graph);$.expect($.get$length(result),$.equals(1,100),null,null,false);$.expect($.index(result,0),$.unorderedEquals([1,2,3,4,5]),null,null,false);};
...
$.Random_Random = function(seed){return $.CTC54;};
...
$.TestAttachedEvents__testRemove = function(){var obj=$.TestAttachedEvents$();var watcher1=$.EventWatcher$();var h1=$.get$TestAttachedEvents__testEvent1().addHandler$2(obj,watcher1.get$handler());$.expect($.get$TestAttachedEvents__testEvent1().removeHandler$2(obj,h1),$.CTC15,null,null,false);$.expect($.get$TestAttachedEvents__testEvent1().removeHandler$2(obj,h1),$.CTC,null,null,false);$.expect($.get$TestAttachedEvents__testEvent1().removeHandler$2(obj,$.GlobalId_GlobalId()),$.CTC,null,null,false);$.expect(new $.TestAttachedEvents__testRemove_anon(obj),$.CTC20,null,null,false);$.expect(new $.TestAttachedEvents__testRemove_anon0(),$.CTC20,null,null,false);$.expect($.get$TestAttachedEvents__testEvent1().removeHandler$2($.TestAttachedEvents$(),$.GlobalId_GlobalId()),$.CTC,null,null,false);};
...
$.TestProperties$ = function(){return new $.TestProperties($.HashMapImplementation$(),$.HashMapImplementation$(),false);};
...
$.HashSetImplementation_HashSetImplementation$from = function(other){var set=$.HashSetImplementation$();for(var t1=$.iterator(other);t1.hasNext$0()===true;)set.add$1(t1.next$0());return set;};
...
$.reduce = function(receiver,initialValue,f){if(!$.isJsArray(receiver))return receiver.reduce$2(initialValue,f);else return $.Collections_reduce(receiver,initialValue,f);};
...
$.HashSet_HashSet$from = function(other){return $.HashSetImplementation_HashSetImplementation$from(other);};
...
$.TestAttachedEvents$ = function(){return new $.TestAttachedEvents($.HashMapImplementation$(),$.HashMapImplementation$(),false);};
...
$.TestPropertyEventIntegration$ = function(){var t1=new $.TestPropertyEventIntegration($.EventHandle$(),$.EventHandle$(),$.HashMapImplementation$(),$.HashMapImplementation$(),false);t1.TestPropertyEventIntegration$0();return t1;};
...
$.EventWatcher$ = function(){return new $.EventWatcher(null,0);};
...
$.toRadixString = function(receiver,radix){if(!(typeof receiver==='number'))return receiver.toRadixString$1(radix);$.checkNum(radix);if(radix<2||radix>36)throw $.$$throw($.ArgumentError$(radix));return receiver.toString(radix);};
...
$.TestProperties_testFactories = function(prop,setValue,propFactoryValue){var wodWatcher=$.EventWatcher$();var object=$.TestProperties$();prop.addHandler$2(object,wodWatcher.get$handler());var t1=prop.get$1(object);var t2=prop.defaultValue;$.expect(t1,$.equals(t2,100),null,null,false);$.expect(prop.getCore$1(object),$.equals($.CTC18,100),null,null,false);$.expect(wodWatcher.get$eventCount(),$.equals(0,100),null,null,false);prop.set$2(object,setValue);$.expect(prop.get$1(object),$.equals(setValue,100),null,null,false);$.expect(prop.getCore$1(object),$.equals(setValue,100),null,null,false);$.expect(wodWatcher.get$eventCount(),$.equals(1,100),null,null,false);var propFactory=new $.TestProperties_testFactories_anon(propFactoryValue);$.expect(prop.get$2(object,propFactory),$.equals(setValue,100),null,null,false);$.expect(prop.getCore$1(object),$.equals(setValue,100),null,null,false);$.expect(wodWatcher.get$eventCount(),$.equals(1,100),null,null,false);prop.clear$1(object);$.expect(wodWatcher.get$eventCount(),$.equals(2,100),null,null,false);$.expect(prop.get$1(object),$.equals(t2,100),null,null,false);$.expect(prop.getCore$1(object),$.equals($.CTC18,100),null,null,false);$.expect(prop.get$2(object,propFactory),$.equals(propFactoryValue,100),null,null,false);$.expect(prop.getCore$1(object),$.equals(propFactoryValue,100),null,null,false);$.expect(wodWatcher.get$eventCount(),$.equals(3,100),null,null,false);};
...
$.CTC71 = 4;
$.CTC72 = 15;
$.CTC73 = Isolate.makeConstantList([2, 32, 14, 4, 33, 15]);
$.CTC74 = 'NullPointerException';
$.CTC75 = new Isolate.$isolateProperties._NullPointerException('NullPointerException');
$.CTC76 = false;
$.CTC40 = new Isolate.$isolateProperties.TestListBase(false);
$.CTC16 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC77 = 26;
$.CTC78 = 19;
$.CTC79 = Isolate.makeConstantList([1, 26, 19]);
...
$.CTC85 = 132;
$.CTC86 = 158;
$.CTC87 = Isolate.makeConstantList([6, 28, 54, 80, 106, 132, 158]);
$.CTC88 = 16;
$.CTC89 = Isolate.makeConstantList([1, 26, 16]);
$.CTC90 = 44;
$.CTC91 = Isolate.makeConstantList([1, 44, 34]);
$.CTC92 = 50;
$.CTC93 = Isolate.makeConstantList([2, 50, 32]);
$.CTC94 = 86;
$.CTC95 = 68;
...
$.CTC100 = 13;
$.CTC101 = 40;
$.CTC102 = Isolate.makeConstantList([4, 39, 13, 1, 40, 14]);
$.CTC103 = 25;
$.CTC104 = Isolate.makeConstantList([4, 25, 9]);
$.CTC105 = 60;
$.CTC106 = 38;
$.CTC107 = 61;
$.CTC108 = Isolate.makeConstantList([2, 60, 38, 2, 61, 39]);
$.CTC109 = Isolate.makeConstantList([1, 26, 13]);
$.CTC110 = 18;
$.CTC111 = Isolate.makeConstantList([6, 18]);
$.CTC112 = 'UnsupportedOperationException';
$.CTC113 = new Isolate.$isolateProperties._UnsupportedOperationException('UnsupportedOperationException');
$.CTC35 = new Isolate.$isolateProperties._Throws(Isolate.$isolateProperties.CTC113);
$.CTC114 = 'ArgumentError';
$.CTC115 = new Isolate.$isolateProperties._ArgumentError('ArgumentError');
...
$.CTC124 = 59;
$.CTC125 = 37;
$.CTC126 = Isolate.makeConstantList([3, 58, 36, 2, 59, 37]);
$.CTC127 = 30;
$.CTC128 = Isolate.makeConstantList([6, 30]);
$.CTC129 = 43;
$.CTC130 = Isolate.makeConstantList([6, 43, 15, 2, 44, 16]);
$.CTC131 = Isolate.makeConstantList([4, 43, 15]);
$.CTC132 = 84;
$.CTC133 = 110;
$.CTC134 = 136;
$.CTC135 = 162;
$.CTC136 = Isolate.makeConstantList([6, 32, 58, 84, 110, 136, 162]);
$.CTC137 = Isolate.makeConstantList([4, 40, 14, 2, 41, 15]);
$.CTC138 = 'IndexOutOfRangeException';
$.CTC139 = new Isolate.$isolateProperties._IndexOutOfRangeException('IndexOutOfRangeException');
$.CTC44 = new Isolate.$isolateProperties._Throws(Isolate.$isolateProperties.CTC139);
$.CTC140 = 17;
$.CTC141 = Isolate.makeConstantList([4, 36, 16, 4, 37, 17]);
$.CTC142 = 69;
$.CTC143 = 70;
$.CTC144 = Isolate.makeConstantList([4, 69, 43, 1, 70, 44]);
$.CTC145 = Isolate.makeConstantList([6, 26]);
$.CTC146 = 'The input sequence contains more than one element.';
$.CTC37 = new Isolate.$isolateProperties.InvalidOperationException('The input sequence contains more than one element.');
$.CTC147 = 24;
$.CTC148 = Isolate.makeConstantList([2, 50, 24]);
$.CTC149 = Isolate.makeConstantList([6, 28, 50]);
$.CTC150 = 49;
$.CTC151 = 31;
$.CTC152 = Isolate.makeConstantList([4, 49, 31]);
$.CTC153 = Isolate.makeConstantList([6, 32, 58]);
$.CTC154 = 35;
$.CTC155 = Isolate.makeConstantList([2, 35, 13]);
$.CTC156 = Isolate.makeConstantList([4, 36, 12, 4, 37, 13]);
$.CTC157 = 98;
$.CTC158 = 78;
$.CTC159 = Isolate.makeConstantList([2, 98, 78]);
$.CTC160 = Isolate.makeConstantList([6, 30, 54]);
$.CTC161 = Isolate.makeConstantList([2, 35, 17]);
$.CTC162 = Isolate.makeConstantList([1, 44, 28]);
$.CTC163 = 46;
$.CTC164 = Isolate.makeConstantList([6, 26, 46]);
...
$.CTC168 = 22;
$.CTC169 = Isolate.makeConstantList([6, 22, 38]);
$.CTC170 = 27;
...
$.CTC177 = Isolate.makeConstantList([6, 34]);
$.CTC178 = 42;
$.CTC179 = Isolate.makeConstantList([6, 24, 42]);
$.CTC180 = null;
...
$.CTC182 = 'Cannot removeLast on immutable List.';
...
$.CTC185 = Isolate.makeConstantList([1, 44, 16]);
$.CTC186 = 72;
$.CTC187 = 94;
$.CTC188 = Isolate.makeConstantList([6, 28, 50, 72, 94]);
$.CTC189 = 62;
$.CTC190 = 90;
$.CTC191 = 118;
$.CTC192 = Isolate.makeConstantList([6, 34, 62, 90, 118]);
$.CTC193 = Isolate.makeConstantList([4, 43, 19]);
$.CTC194 = Isolate.makeConstantList([6, 22]);
$.CTC195 = 74;
$.CTC196 = Isolate.makeConstantList([6, 26, 50, 74, 98]);
$.CTC197 = 'structured clone of ArrayBuffer';
$.CTC8 = new Isolate.$isolateProperties.NotImplementedException('structured clone of ArrayBuffer');
$.CTC198 = Isolate.makeConstantList([6, 34, 62, 90]);
$.CTC199 = Isolate.makeConstantList([6, 28, 54, 80, 106]);
$.CTC200 = 87;
$.CTC201 = Isolate.makeConstantList([2, 86, 68, 2, 87, 69]);
$.CTC202 = 82;
$.CTC203 = 138;
$.CTC204 = 166;
...
$.CTC219 = Isolate.makeConstantList([6, 32, 58, 84, 110]);
$.CTC220 = Isolate.makeConstantList([6, 30, 54, 78, 102]);
...
$.CTC234 = 'NullArgumentException';
$.CTC235 = new Isolate.$isolateProperties._NullArgumentException('NullArgumentException');
$.CTC236 = 'structured clone of RegExp';
...
$.CTC242 = 55;
$.CTC243 = Isolate.makeConstantList([1, 70, 55]);
$.CTC244 = 134;
$.CTC245 = 108;
...
$.CTC250 = 20;
$.CTC251 = Isolate.makeConstantList([6, 43, 19, 2, 44, 20]);
$.CTC252 = Isolate.makeConstantList([Isolate.$isolateProperties.CTC79, Isolate.$isolateProperties.CTC89, Isolate.$isolateProperties.CTC109, Isolate.$isolateProperties.CTC98, Isolate.$isolateProperties.CTC91, Isolate.$isolateProperties.CTC162, Isolate.$isolateProperties.CTC184, Isolate.$isolateProperties.CTC185, Isolate.$isolateProperties.CTC243, Isolate.$isolateProperties.CTC240, Isolate.$isolateProperties.CTC161, Isolate.$isolateProperties.CTC155, Isolate.$isolateProperties.CTC167, Isolate.$isolateProperties.CTC93, Isolate.$isolateProperties.CTC148, Isolate.$isolateProperties.CTC104, Isolate.$isolateProperties.CTC246, Isolate.$isolateProperties.CTC239, Isolate.$isolateProperties.CTC121, Isolate.$isolateProperties.CTC67, Isolate.$isolateProperties.CTC96, Isolate.$isolateProperties.CTC171, Isolate.$isolateProperties.CTC193, Isolate.$isolateProperties.CTC131, Isolate.$isolateProperties.CTC159, Isolate.$isolateProperties.CTC152, Isolate.$isolateProperties.CTC73, Isolate.$isolateProperties.CTC102, Isolate.$isolateProperties.CTC118, Isolate.$isolateProperties.CTC108, Isolate.$isolateProperties.CTC120, Isolate.$isolateProperties.CTC137, Isolate.$isolateProperties.CTC249, Isolate.$isolateProperties.CTC126, Isolate.$isolateProperties.CTC141, Isolate.$isolateProperties.CTC156, Isolate.$isolateProperties.CTC201, Isolate.$isolateProperties.CTC144, Isolate.$isolateProperties.CTC251, Isolate.$isolateProperties.CTC130]);
$.CTC20 = new Isolate.$isolateProperties._Throws0(Isolate.$isolateProperties.CTC235);
$.CTC54 = new Isolate.$isolateProperties._Random();
$.CTC253 = 56;
$.CTC254 = Isolate.makeConstantList([6, 30, 56, 82]);
$.CTC255 = 48;
$.CTC256 = Isolate.makeConstantList([6, 26, 48, 70]);
$.CTC257 = Isolate.makeConstantList([6, 30, 58, 86]);
$.CTC258 = 66;
$.CTC259 = Isolate.makeConstantList([6, 26, 46, 66]);
$.CTC260 = 126;
...
$.CTC57 = Isolate.makeConstantList([Isolate.$isolateProperties.CTC1, Isolate.$isolateProperties.CTC111, Isolate.$isolateProperties.CTC194, Isolate.$isolateProperties.CTC145, Isolate.$isolateProperties.CTC128, Isolate.$isolateProperties.CTC177, Isolate.$isolateProperties.CTC169, Isolate.$isolateProperties.CTC179, Isolate.$isolateProperties.CTC164, Isolate.$isolateProperties.CTC149, Isolate.$isolateProperties.CTC160, Isolate.$isolateProperties.CTC153, Isolate.$isolateProperties.CTC206, Isolate.$isolateProperties.CTC259, Isolate.$isolateProperties.CTC256, Isolate.$isolateProperties.CTC237, Isolate.$isolateProperties.CTC232, Isolate.$isolateProperties.CTC254, Isolate.$isolateProperties.CTC257, Isolate.$isolateProperties.CTC198, Isolate.$isolateProperties.CTC188, Isolate.$isolateProperties.CTC196, Isolate.$isolateProperties.CTC220, Isolate.$isolateProperties.CTC199, Isolate.$isolateProperties.CTC219, Isolate.$isolateProperties.CTC233, Isolate.$isolateProperties.CTC192, Isolate.$isolateProperties.CTC263, Isolate.$isolateProperties.CTC261, Isolate.$isolateProperties.CTC267, Isolate.$isolateProperties.CTC268, Isolate.$isolateProperties.CTC270, Isolate.$isolateProperties.CTC271, Isolate.$isolateProperties.CTC272, Isolate.$isolateProperties.CTC274, Isolate.$isolateProperties.CTC176, Isolate.$isolateProperties.CTC87, Isolate.$isolateProperties.CTC136, Isolate.$isolateProperties.CTC205, Isolate.$isolateProperties.CTC224]);
...
$.CTC38 = new Isolate.$isolateProperties._Throws(Isolate.$isolateProperties.CTC75);
$.CTC281 = '^#(?:[0-9a-f]{6})$';
...
$.CTC291 = 'structured clone of other type';
...
$.CTC293 = 'Mutation operations are not supported';
...
$._lazyPort = null;
$.isNullPointerException = Isolate.$isolateProperties.CTC75;
...
$.isArgumentError = Isolate.$isolateProperties.CTC115;
...
$.isIndexOutOfRangeException = Isolate.$isolateProperties.CTC139;
$._currentTest = 0;
...
$.QrMode_MODE_KANJI = 8;
$.isUnsupportedOperationException = Isolate.$isolateProperties.CTC113;
$._soloTest = null;
...
Isolate.$lazy($, '_testEvent1', 'TestAttachedEvents__testEvent1', 'get$TestAttachedEvents__testEvent1', function(){return $.AttachedEvent$('testEvent1');});
Isolate.$lazy($, '_ageProperty', 'TestPropertyEventIntegration__ageProperty', 'get$TestPropertyEventIntegration__ageProperty', function(){return $.Property$('age',0);});
Isolate.$lazy($, '_nameProperty', 'TestPropertyEventIntegration__nameProperty', 'get$TestPropertyEventIntegration__nameProperty', function(){return $.Property$('name',null);});
var $ = null;
Isolate.$finishClasses($$);
$$ = {};
...
$.$defineNativeClass('HTMLDocument', ["body?", "head?"], {
 ...
 $dom_querySelector$1: function(selectors){return this.querySelector(selectors);},
 $dom_querySelectorAll$1: function(selectors){return this.querySelectorAll(selectors);},
 query$1: function(selectors){if($.CTC28.hasMatch$1(selectors)===true)return this.$dom_getElementById$1($.substring$1(selectors,1));return this.$dom_querySelector$1(selectors);},
...
$.$defineNativeClass('IDBIndex', ["name?"], {
 ...
 get$1: function(key){var t1=$===key;if(t1)key=null;t1=!t1;if(typeof key==='object'&&key!==null&&key.is$IDBKeyRange()||key==null)return this._get_1$1(key);if(t1)return this._get_2$1(key);throw $.$$throw($.CTC17);},
...
$.$defineNativeClass('NodeList', ["length?"], {
 ...
 every$1: function(f){  if (Object.getPrototypeOf(this).hasOwnProperty('every$1')) {
  {return $._Collections_every(this,f);}  } else {
