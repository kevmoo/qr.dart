...
$$.Box = {"": ["left?", "top?", "width?", "height?"],
 ...
 getCorners$0: function() {
  var t1 = this.left;
  var t2 = this.top;
  var t3 = $.Coordinate$(t1, t2);
  var t4 = this.width;
  if (typeof t4 !== 'number')
    throw $.iae(t4);
  var t5 = $.Coordinate$(t1 + t4, t2);
  t4 = t1 + t4;
  var t6 = this.height;
  if (typeof t6 !== 'number')
    throw $.iae(t6);
...
$$.Stage = {"": ["_invalidatedEventHandle", "_lib1_canvas", "_element?", "_ctx", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "AttachableObject",
...
$.RetainedDebug__borderElement = function(ctx, element, excludeChildren, filter) {
  ...
  if (excludeChildren !== true && typeof element === 'object' && element !== null && !!element.is$ParentElement) {
    var i = 0;
    while (true) {
      var t1 = element.get$visualChildCount();
      if (typeof t1 !== 'number')
...
$.RetainedDebug__borderElementCore = function(ctx, element) {
  ...
  var corners = $.RetainedUtil_getCorners(element);
  ctx.beginPath$0();
  ctx.moveTo$2($.index(corners, 3).get$x(), $.index(corners, 3).get$y());
  for (var t1 = $.iterator(corners); t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
...
$.RetainedDebug_borderHitTest = function(stage, point) {
  var ctx = stage.get$ctx();
  var hits = $.RetainedUtil_hitTest(stage, point);
  if ($.gtB($.get$length(hits), 0)) {
    ctx.save$0();
    ctx.set$lineWidth(2);
    $.forEach(hits, new $.RetainedDebug_borderHitTest_anon(ctx));
    ctx.restore$0();
  }
};
...
$.SpinDemo_SpinDemo = function(canvas) {
  var pCanvas = $.PCanvas$(200, 200, false);
  var blue = $.Shape$(100, 100, 'blue', $.CTC14);
  var green = $.Shape$(70, 70, 'green', $.CTC14);
  var red = $.Shape$(40, 40, 'red', $.CTC15);
...
$.RetainedUtil_getCorners = function(element) {
  return $.map($.$$($.Box$(0, 0, element.get$width(), element.get$height()).getCorners$0()), new $.RetainedUtil_getCorners_anon(element)).toList$0();
};
...
$.CTC35 = 'characterData';
$.CTC36 = 'subtree';
$.CTC37 = 'attributeOldValue';
$.CTC38 = 'characterDataOldValue';
$.CTC39 = Isolate.makeConstantList(['childList', 'attributes', 'characterData', 'subtree', 'attributeOldValue', 'characterDataOldValue']);
$.CTC40 = true;
$.CTC22 = new Isolate.$isolateProperties.ConstantMap(6, {'childList': true, 'attributes': true, 'characterData': true, 'subtree': true, 'attributeOldValue': true, 'characterDataOldValue': true}, Isolate.$isolateProperties.CTC39);
...
$.CTC48 = 'offsetX is only supported on elements';
...
$.CTC25 = new Isolate.$isolateProperties.EmptyElementRect(Isolate.$isolateProperties.CTC51, Isolate.$isolateProperties.CTC51, Isolate.$isolateProperties.CTC51, Isolate.$isolateProperties.CTC51, Isolate.$isolateProperties.CTC1);
$.CTC52 = 'Rect';
$.CTC14 = new Isolate.$isolateProperties.ShapeType('Rect');
$.CTC53 = 'Ellipse';
$.CTC15 = new Isolate.$isolateProperties.ShapeType('Ellipse');
$.CTC54 = 'Incorrect number or type of arguments';
$.CTC24 = new Isolate.$isolateProperties._ExceptionImplementation('Incorrect number or type of arguments');
$.CTC55 = new Isolate.$isolateProperties.Coordinate(0, 0);
$.CTC56 = 'offsetY is only supported on elements';
$.CTC17 = new Isolate.$isolateProperties.UnsupportedOperationException('offsetY is only supported on elements');
...
$.CTC59 = 'structured clone of ImageData';
...
$.Property_Undefined = Isolate.$isolateProperties.CTC27;
