...
$$._MeasurementScheduler = {"":
 ...
 _onCallback$0: function(){if(this._nextMeasurementFrameScheduled!==true)return;this._nextMeasurementFrameScheduled=false;this._callback$0();}
};
...
$$.Box = {"":
 ...
 getCorners$0: function(){var t1=this.left;var t2=this.top;var t3=$.Coordinate$(t1,t2);var t4=this.width;if(typeof t4!=='number')throw $.iae(t4);var t5=$.Coordinate$(t1+t4,t2);if(typeof t4!=='number')throw $.iae(t4);t4=t1+t4;var t6=this.height;if(typeof t6!=='number')throw $.iae(t6);t4=$.Coordinate$(t4,t2+t6);if(typeof t6!=='number')throw $.iae(t6);return [t3,t5,t4,$.Coordinate$(t1,t2+t6)];},
...
$.CTC36 = true;
$.CTC23 = new Isolate.$isolateProperties.ConstantMap(6, {'childList': true, 'attributes': true, 'characterData': true, 'subtree': true, 'attributeOldValue': true, 'characterDataOldValue': true}, Isolate.$isolateProperties.CTC35);
...
$.CTC49 = 'Incorrect number or type of arguments';
...
$.CTC25 = new Isolate.$isolateProperties.EmptyElementRect(Isolate.$isolateProperties.CTC42, Isolate.$isolateProperties.CTC42, Isolate.$isolateProperties.CTC42, Isolate.$isolateProperties.CTC42, Isolate.$isolateProperties.CTC1);
