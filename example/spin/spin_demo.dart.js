...
$$.HashMapImplementation = {"":
 ...
 remove$1: function(key){var index=this._probeForLookup$1(key);if($.geB(index,0)){this._numberOfEntries=this._numberOfEntries-1;var t1=this._values;if(index!==(index|0))throw $.iae(index);if(index<0||index>=t1.length)throw $.ioore(index);var value=t1[index];t1[index]=null;t1=this._keys;if(index<0||index>=t1.length)throw $.ioore(index);t1[index]=$.CTC16;this._numberOfDeleted=this._numberOfDeleted+1;return value;}return;},
...
$$.DoubleLinkedQueue = {"":
 ...
 map$1: function(f){var other=$.Queue_Queue();var entry=this._sentinel._next;for(;!(entry===this._sentinel);){var nextEntry=entry.get$_next();$.addLast(other,f.call$1(entry.get$_lib0_element()));entry=nextEntry;}return other;},
...
$$.FormatException = {"":
 ["message?"],
 "super": "Object",
 toString$0: function(){return 'FormatException: '+this.message;},
 is$Exception: true
};
...
$$.ConstantMap = {"":
 ...
 forEach$1: function(f){$.forEach(this._lib2_keys,new $.ConstantMap_forEach_anon(this,f));},
 getKeys$0: function(){return this._lib2_keys;},
 getValues$0: function(){var result=[];$.forEach(this._lib2_keys,new $.ConstantMap_getValues_anon(this,result));return result;},
 isEmpty$0: function(){return $.eq($.get$length(this),0);},
 toString$0: function(){return $.Maps_mapToString(this);},
...
$$.Box = {"":
 ...
 getCorners$0: function(){var t1=this.left;var t2=this.top;var t3=$.Coordinate$(t1,t2);var t4=this.width;if(typeof t4!=='number')throw $.iae(t4);var t5=$.Coordinate$(t1+t4,t2);t4=t1+t4;var t6=this.height;if(typeof t6!=='number')throw $.iae(t6);return [t3,t5,$.Coordinate$(t4,t2+t6),$.Coordinate$(t1,t2+t6)];},
...
$$.AttachableObject = {"":
 ...
 _getValueOrUndefined$3: function(key,obj,ifAbsent){this.validateNotDisposed$0();if(this._isSet$1(key)===true)return this._propertyValues.operator$index$1(key);else if(!(ifAbsent==null)){var value=ifAbsent.call$1(obj);this._set$2(key,value);return value;}else return $.CTC25;},
...
$$.Property = {"":
 ["defaultValue", "name"],
 "super": "Attachable",
 get$2: function(obj,ifAbsent){var coreValue=this.getCore$2(obj,ifAbsent);if(!$.identical(coreValue,$.CTC25))return coreValue;else return this.defaultValue;},
 get$1: function(obj) {
...
$$.PElement = {"":
 ...
 update$0: function(){this._updatedEventHandle.fireEvent$1($.CTC18);},
 ...
 _invalidateParent$0: function(){this._invalidatedEventHandle.fireEvent$1($.CTC18);this._lib1_parent.childInvalidated$1(this);}
};
...
$$.Stage = {"":
 ["_invalidatedEventHandle", "_lib1_canvas", "_element?", "_ctx", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "AttachableObject",
 get$rootElement: function(){return this._element;},
 get$ctx: function(){this.validateNotDisposed$0();if(this._ctx==null)this._ctx=this._lib1_canvas.get$context2d();return this._ctx;},
 draw$0: function(){this.validateNotDisposed$0();var t1=this._ctx;var t2=t1==null;var t3=this._lib1_canvas;if(t2)this._ctx=t3.get$context2d();else t1.clearRect$4(0,0,t3.get$width(),t3.get$height());return this._element.draw$1(this._ctx);},
 childInvalidated$1: function(child){this.validateNotDisposed$0();this._invalidatedEventHandle.fireEvent$1($.CTC18);},
...
$$.Shape = {"":
 ["_fillStyle", "shapeType", "_transforms", "cacheEnabled", "_updatedEventHandle", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib1_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "PElement",
 ...
 toString$0: function(){return 'Shape ['+$.S(this._fillStyle)+', '+$.S(this.shapeType.name)+']';}
};
...
$$._MutationObserverImpl_observe_anon = {"":
 ["parsedOptions_0"],
 "super": "Closure",
 call$2: function(k,v){if($.CTC21.containsKey$1(k)===true)this.parsedOptions_0[k] = true===v;else if($.eqB(k,'attributeFilter'))this.parsedOptions_0[k] = v;else throw $.$$throw($.ArgumentError$('Illegal MutationObserver.observe option \''+$.S(k)+'\''));}
};
...
$$._NativeJsSendPort_send_anon = {"":
 ...
 "super": "Closure",
 call$0: function(){var t1={};var t2=this.this_5;var t3=this.replyTo_3;t2._checkReplyTo$1(t3);var isolate=$.index($._globalState().get$isolates(),t2.get$_isolateId());if(isolate==null)return;if(t2.get$_receivePort().get$_lib3_callback()==null)return;var shouldSerialize=!($._globalState().get$currentContext()==null)&&!$.eqB($._globalState().get$currentContext().get$id(),t2.get$_isolateId());var msg=this.message_4;t1.msg_1=msg;t1.reply_2=t3;if(shouldSerialize){t1.msg_1=$._serializeMessage(t1.msg_1);t1.reply_2=$._serializeMessage(t1.reply_2);}$._globalState().get$topEventLoop().enqueue$3(isolate,new $._NativeJsSendPort_send_anon0(t2,t1,shouldSerialize),'receive '+$.S(msg));}
};

$$._NativeJsSendPort_send_anon0 = {"":
 ["this_7", "box_0", "shouldSerialize_6"],
 "super": "Closure",
 call$0: function(){var t1=this.this_7;if(!(t1.get$_receivePort().get$_lib3_callback()==null)){if(this.shouldSerialize_6===true){var t2=this.box_0;t2.msg_1=$._deserializeMessage(t2.msg_1);t2.reply_2=$._deserializeMessage(t2.reply_2);}t1=t1.get$_receivePort();t2=this.box_0;t1._lib3_callback$2(t2.msg_1,t2.reply_2);}}
};
...
$.RetainedDebug__borderElementCore = function(ctx,element){if($.get$Mouse_isMouseDirectlyOverProperty().get$1(element)===true)ctx.set$strokeStyle('red');else if($.get$Mouse_isMouseOverProperty().get$1(element)===true)ctx.set$strokeStyle('pink');else if(element.get$cacheEnabled()===true)ctx.set$strokeStyle('yellow');else ctx.set$strokeStyle('orange');var corners=$.RetainedUtil_getCorners(element);ctx.beginPath$0();ctx.moveTo$2($.index(corners,3).get$x(),$.index(corners,3).get$y());for(var t1=$.iterator(corners);t1.hasNext$0()===true;){var t2=t1.next$0();ctx.lineTo$2(t2.get$x(),t2.get$y());}ctx.stroke$0();};
...
$.Shape$ = function(w,h,fillStyle,shapeType){return new $.Shape(fillStyle,shapeType,$.ListImplementation_List(null),true,$.EventHandle$(),$.EventHandle$(),null,w,h,null,null,false,null,$.HashMapImplementation$(),$.HashMapImplementation$(),false);};
...
$.RetainedUtil_getCorners = function(element){return $.map($.$$($.Box$(0,0,element.get$width(),element.get$height()).getCorners$0()),new $.RetainedUtil_getCorners_anon(element)).toList$0();};
...
$.CTC31 = 'characterData';
$.CTC32 = 'subtree';
$.CTC33 = 'attributeOldValue';
$.CTC34 = 'characterDataOldValue';
$.CTC35 = Isolate.makeConstantList(['childList', 'attributes', 'characterData', 'subtree', 'attributeOldValue', 'characterDataOldValue']);
$.CTC36 = true;
$.CTC21 = new Isolate.$isolateProperties.ConstantMap(6, {'childList': true, 'attributes': true, 'characterData': true, 'subtree': true, 'attributeOldValue': true, 'characterDataOldValue': true}, Isolate.$isolateProperties.CTC35);
...
$.CTC57 = 'structured clone of ImageData';
...
$.ShapeType_rect = Isolate.$isolateProperties.CTC14;
$.ShapeType_ellipse = Isolate.$isolateProperties.CTC15;
$._getTypeNameOf = null;
...
$.$defineNativeClass('DocumentFragment', [], {
 ...
 get$attributes: function(){return $.CTC24;},
