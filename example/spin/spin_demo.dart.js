...
$$.PElement = {"":
 ...
 update$0: function() {
  this._updatedEventHandle.fireEvent$1($.CTC18);
},
...
$.RetainedDebug__borderElement = function(ctx, element, excludeChildren, filter) {
  ...
  if (!excludeChildren) {
    ...
    while (true) {
      ...
      if (typeof t1 !== 'number')
        return $.RetainedDebug__borderElement$bailout(1, ctx, element, filter, i, t1);
      if (!(i < t1))
        break;
...
$.RetainedDebug__borderElement$bailout = function(state, env0, env1, env2, env3, env4) {
  switch (state) {
    case 1:
      var ctx = env0;
      var element = env1;
  ...
  switch (state) {
    case 0:
      if (filter == null || filter.call$1(element) === true)
        $.RetainedDebug__borderElementCore(ctx, element);
    case 1:
      if (state === 1 || state === 0 && !excludeChildren)
        switch (state) {
          case 0:
            var i = 0;
          case 1:
