...
$$.DateImplementation = {"":
 ...
 difference$1: function(other){var ms=this.millisecondsSinceEpoch;if(typeof ms!=='number')return this.difference$1$bailout(1,other,ms);var otherMs=other.get$millisecondsSinceEpoch();if(typeof otherMs!=='number')return this.difference$1$bailout(2,ms,otherMs);return $.Duration$(0,0,ms-otherMs,0,0);},
 difference$1$bailout: function(state,env0,env1){switch(state){case 1:var other=env0;ms=env1;break;case 2:ms=env0;otherMs=env1;break;}switch(state){case 0:var ms=this.millisecondsSinceEpoch;case 1:state=0;var otherMs=other.get$millisecondsSinceEpoch();case 2:state=0;return $.Duration$(0,0,$.sub(ms,otherMs),0,0);}},
...
$$.HashMapImplementation = {"":
 ...
 remove$1: function(key){var index=this._probeForLookup$1(key);if($.geB(index,0)){this._numberOfEntries=this._numberOfEntries-1;var t1=this._values;if(index!==(index|0))throw $.iae(index);if(index<0||index>=t1.length)throw $.ioore(index);var value=t1[index];t1[index]=null;t1=this._keys;if(index<0||index>=t1.length)throw $.ioore(index);t1[index]=$.CTC14;this._numberOfDeleted=this._numberOfDeleted+1;return value;}return;},
...
$$.ConstantMap = {"":
 ...
 isEmpty$0: function(){return $.eq($.get$length(this),0);},
 toString$0: function(){return $.Maps_mapToString(this);},
 _throwImmutable$0: function(){throw $.$$throw($.CTC19);},
...
$$.DraggerDemo = {"":
 ...
 _onDragStart$1: function(e){if(!this._overShape)e.cancel$0();},
...
$$._MeasurementScheduler = {"":
 ...
 _onCallback$0: function(){if(!this._nextMeasurementFrameScheduled)return;this._nextMeasurementFrameScheduled=false;this._lib_callback$0();}
};
...
$$._SelectIterator = {"":
 ...
 next$0: function(){return this._lib3_func$1(this._source.next$0());}
};
...
$$.AttachableObject = {"":
 ...
 _lib3_remove$1: function(key){this.validateNotDisposed$0();if(this._isSet$1(key)===true){this._propertyValues.remove$1(key);this._fireChange$1(key);}},
 _getValueOrUndefined$3: function(key,obj,ifAbsent){this.validateNotDisposed$0();if(this._isSet$1(key)===true)return this._propertyValues.operator$index$1(key);else if(!(ifAbsent==null)){var value=ifAbsent.call$1(obj);this._set$2(key,value);return value;}else return $.CTC23;},
...
$$.Property = {"":
 ["defaultValue", "name"],
 "super": "Attachable",
 get$2: function(obj,ifAbsent){var coreValue=this.getCore$2(obj,ifAbsent);if(!$.identical(coreValue,$.CTC23))return coreValue;else return this.defaultValue;},
 get$1: function(obj) {
 ...
 clear$1: function(obj){return obj._lib3_remove$1(this);},
...
$$.Stage = {"":
 ["_invalidatedEventHandle", "_lib1_canvas", "_lib1_element?", "_ctx", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "AttachableObject",
 ...
 draw$0: function(){this.validateNotDisposed$0();var t1=this._ctx;var t2=t1==null;var t3=this._lib1_canvas;if(t2)this._ctx=t3.get$context2d();else t1.clearRect$4(0,0,t3.get$width(),t3.get$height());return this._lib1_element.draw$1(this._ctx);},
...
$$.ImgElement = {"":
 [],
 "super": "PElement",
 drawOverride$1: function(ctx){var t1=this._image;if(t1.get$complete()===true)this._doDraw$1(ctx);else if(!this._waitingOnLoad){this._waitingOnLoad=true;$.add$1(t1.get$on().get$load(),this.get$_onImageLoad());}},
...
$$.SpriteElement = {"":
 ["startCoordinate", "nextDelta", "count", "_frame", "_image", "_waitingOnLoad", "_transforms", "cacheEnabled", "_updatedEventHandle", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib1_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "ImgElement",
 _doDraw$1: function(ctx){var t1=this.count;var msPerFrame=$.tdiv(1000,t1);var theFrame=$.mod($.tdiv($.toInt($.window().get$performance().webkitNow$0()),msPerFrame),t1);var rect=$.Box_Box$fromCoordSize(this.startCoordinate.operator$add$1(this.nextDelta.operator$mul$1(theFrame)),this.get$size());$.CanvasUtil_drawImage(ctx,this._image,rect,null);}
};
...
$$._demoIsolate_anon = {"":
 [],
 "super": "Closure",
 call$1: function(input){var start=$.Date_Date$now();var delta=null;do delta=$.Date_Date$now().difference$1(start);while($.ltB(delta.get$inSeconds(),1));return $.mul(input.get$x(),input.get$y());}
};
...
$$._MutationObserverImpl_observe_anon = {"":
 ["parsedOptions_0"],
 "super": "Closure",
 call$2: function(k,v){if($.CTC18.containsKey$1(k)===true)this.parsedOptions_0[k] = true===v;else if($.eqB(k,'attributeFilter'))this.parsedOptions_0[k] = v;else throw $.$$throw($.ArgumentError$('Illegal MutationObserver.observe option \''+$.S(k)+'\''));}
};
...
$.SpriteElement_SpriteElement$horizontalFromUrl = function(src,w,h,count,xDelta,start){return $.SpriteElement$($.ImageElement_ImageElement(src,null,null),w,h,start,$.Vector$(xDelta,0),count);};
...
$.SpriteElement$ = function(image,width,height,startCoordinate,nextDelta,count){return new $.SpriteElement(startCoordinate,nextDelta,count,0,image,false,$.ListImplementation_List(null),false,$.EventHandle$(),$.EventHandle$(),null,width,height,null,null,false,null,$.HashMapImplementation$(),$.HashMapImplementation$(),false);};
...
$.CTC35 = true;
$.CTC18 = new Isolate.$isolateProperties.ConstantMap(6, {'childList': true, 'attributes': true, 'characterData': true, 'subtree': true, 'attributeOldValue': true, 'characterDataOldValue': true}, Isolate.$isolateProperties.CTC34);
...
$.Property_Undefined = Isolate.$isolateProperties.CTC23;
...
$.$defineNativeClass('IDBIndex', ["name?"], {
 get$1: function(key){var t1=$===key;if(t1)key=null;t1=!t1;if(typeof key==='object'&&key!==null&&key.is$IDBKeyRange()||key==null)return this._get_1$1(key);if(t1)return this._get_2$1(key);throw $.$$throw($.CTC24);},
...
$.$defineNativeClass('MouseEvent', ["clientX?", "clientY?", "x?", "y?"], {
 get$offsetX: function(){if(!!this.offsetX)return this.get$_offsetX();else{var target=this.target;if(!(typeof target==='object'&&target!==null&&target.is$Element()))throw $.$$throw($.CTC25);return $.sub(this.clientX,target.$dom_getBoundingClientRect$0().get$left());}},
 get$offsetY: function(){if(!!this.offsetY)return this.get$_offsetY();else{var target=this.target;if(!(typeof target==='object'&&target!==null&&target.is$Element()))throw $.$$throw($.CTC25);return $.sub(this.clientY,target.$dom_getBoundingClientRect$0().get$top());}},
...
$.$defineNativeClass('DOMWindow', ["length?", "name?", "navigator?", "performance?"], {
