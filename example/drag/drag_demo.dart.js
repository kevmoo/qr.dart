...
$$.DateImplementation = {"":
 ...
 difference$1$bailout: function(state, env0, env1) {
  switch (state) {
    case 1:
      var other = env0;
      ms = env1;
...
$$.DraggerDemo = {"":
 ...
 DraggerDemo$_internal$4: function(_canvas, _stage, _tx, _dragger) {
  ...
  $.add$1(this._demoMapper.get$outputChanged(), new $.anon1(this));
...
$$.FutureValue = {"":
 ...
 set$input: function(value) {
  ...
  if (this._future == null)
    ...
    this._pending = true;
  this._inputChangedHandle.fireEvent$1($.CTC22);
},
 get$output: function() {
  return this._output;
},
 ...
 _futureCompleted$1: function(value) {
  this._future = null;
  this._output = value;
  this._outputChangedHandle.fireEvent$1($.CTC22);
  this._cleanup$0();
},
